...
public class EditorConfig  {
	...
	//工具工程的目录
	public readonly static string ToolsProjectDirRoot = Application.dataPath.Substring(0, Application.dataPath.Length-7); //"D:\\游戏项目\\trunk\\client\\WDJ1.0"; //"D:/XTool";
	//程序员的开发环境根目录
	public readonly static string DevProjectDirRoot = Application.dataPath;// "D:\\游戏项目\\trunk\\client\\WDJ1.0\\Assets";

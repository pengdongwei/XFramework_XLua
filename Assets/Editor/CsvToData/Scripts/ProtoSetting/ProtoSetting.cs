...
public static class ProtoBuildTool
{
	...
	[MenuItem("XTool/Excel/一键拷贝到开发环境(程序编程环境)")]
	...
	[MenuItem("XTool/Excel/一键导出csv+数据生成+拷贝到开发环境(程序编程环境)")]
    ...
    [MenuItem("XTool/Excel/SVN提交修改 %t")]
	...
	static void OpenConfigWindow()
	{
		...
		mProtoSetting.titleContent.text = "Excel";
		mProtoSetting.Show ();
	}
